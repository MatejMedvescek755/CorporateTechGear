...
namespace CorporateTechGear.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,products,total,created_at,user_id")] Orders orders)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,products,total,created_at,user_id")] Orders orders)
        {
            if (id != orders.id)
            {
                return NotFound();
