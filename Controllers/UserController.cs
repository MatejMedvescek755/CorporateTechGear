    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Users != null ? 
                          ...
                          Problem("Entity set 'ShopContext.Users'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("id,email,first_name,last_name,password,address,role,age")] User user)
        {
